...
-- Avara Cosmetics). Safe to run even on a brand-new project.
-- =====================================================================

-- 1. Add the column the old schema didn't have yet (no-op if it exists).
...
--    with a fresh set spread across the three collections. This ONLY
--    touches dept = 'beauty' — Medical advice and Athlete section rows,
--    and any real products you've already added yourself, are untouched.
--    If you've already replaced the sample Beauty products with your own,
--    skip this delete and instead set each product's collection by hand
